...
namespace EFDesigner2022Tests
{
   ...
   /// </summary>
   public partial class EFModelDatabaseDesignTimeFactory: IDesignTimeDbContextFactory<EFModelDatabase>
   {
      /// <summary>
      /// Partial method to allow post-creation configuration of the DbContext after it's created
      /// but before it's returned.
      /// </summary>
      partial void Initialize(EFModelDatabase dbContext);

      /// <summary>Creates a new instance of a derived context.</summary>
      /// <param name="args"> Arguments provided by the design-time service. </param>
      /// <returns> An instance of <see cref="EFDesigner2022Tests.EFModelDatabase" />.</returns>
      public EFModelDatabase CreateDbContext(string[] args)
      {
         DbContextOptionsBuilder<EFModelDatabase> optionsBuilder = new DbContextOptionsBuilder<EFModelDatabase>();

         // Please provide the EFModelDatabase.ConfigureOptions(optionsBuilder) in the partial class as
         ...
         EFModelDatabase.ConfigureOptions(optionsBuilder);
         EFModelDatabase result = new EFModelDatabase(optionsBuilder.Options);
         Initialize(result);
   ...
   /// </remarks>
   public partial class EFModelDatabaseFactory: IDbContextFactory<EFModelDatabase>
   {
      /// <summary>
      /// Partial method to allow post-creation configuration of the DbContext after it's created
      /// but before it's returned.
      ...
      public EFModelDatabase CreateDbContext()
      {
         DbContextOptionsBuilder<EFModelDatabase> optionsBuilder = new DbContextOptionsBuilder<EFModelDatabase>();
